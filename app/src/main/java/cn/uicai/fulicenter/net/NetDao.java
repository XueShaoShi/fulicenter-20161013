...
import cn.uicai.fulicenter.utils.MD5;
...
public class NetDao {
    ...
    public static void register(Context context, String usernaem, String nickname, String password, OkHttpUtils.OnCompleteListener<Result> listener) {
        OkHttpUtils<Result> utils = new OkHttpUtils<Result>(context);
        utils.setRequestUrl(I.REQUEST_REGISTER)
                .addParam(I.User.USER_NAME, usernaem)
